...
- Kajetan will email competition committee
- Dan will start a hackmd for the agenda for the competition committee meeting
- KTC will discuss forming a temporary Kickstart sub-team further in the next meeting
- Rob will schedule a brainstorming session
- Kier will request permission to create subteams on Github
- Kier will create Github repo for KTC minutes and tasks
- KTC will resolve whether they want to approve the kit team addition to the ops manual via email
- Tom will email the people who have signed up so far
